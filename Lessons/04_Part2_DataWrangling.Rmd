...
NTL.nutrient.data.PeterPaul <- droplevels(NTL.nutrient.data.PeterPaul) # droplevels() will get ride of other lake names
summary(NTL.nutrient.data.PeterPaul$lakename)
...
# similar to using pivot tables in Excel
...
# Gather nutrient data into one column using pivot_longer - turning columns into rows
...
# Spread nutrient data into separate columns - turns rows into columns
