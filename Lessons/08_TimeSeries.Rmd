...
3. An **error** or **random** component, which makes up the remainder of the time series after other components have been accounted for. This component reflects the noise in the dataset. <- Mean of random errors should be as close to 0 as possible (no correlation in random errors)
