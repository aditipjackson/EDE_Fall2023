...
#5 & $6.
Name_vector <- c("Anna", "Ben", "Cameron", "Denis") # String variables
Test_score_vector <- c(99,49,97,48) # Float variables
Passed_failed_vector <- c(TRUE,FALSE,TRUE,FALSE) # Boolean variables

#7.
df_student_scores <- as.data.frame(Name_vector,Test_score_vector,Passed_failed_vector)
