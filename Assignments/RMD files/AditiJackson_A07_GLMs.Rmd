...
> Answer:
H0: Mean lake temperature does not change (M == 0)  
...
Lake_Scatter <- ggplot(LakeData_July,aes(x=depth,y=temperature_C))+
  ...
  ylim(0,35)+
  labs(x="Depth",y="Temperature (C)",Title="Temperature by Depth")
...
> Answer: There appears to be an inverse relationship between temperature and depth. For an increase in depth, temperature decreases. [ADD COMMENTS ON LINEARITY.]
...
> Answer: Per the r-squared value, 73.87% of the variability in temperature is explained by changes in depth. [ADD DEGREES OF FREEDOM, ETC.]
