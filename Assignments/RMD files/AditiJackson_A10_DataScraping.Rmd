...
#9
# plotting Asheville's maximum daily withdrawal
ggplot(maxDailyUse_Asheville_2015_df)+
  geom_line(aes(x=Date,y=Maximum.Daily.Use))+
...
#"Map"-ing the function to retrieve data for all these values
maxDailyUse_Asheville_2015_df <- map2(the_yera,the_PWSID, scraping.function) 
