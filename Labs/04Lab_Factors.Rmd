...
sites <- read.csv('./Data/Raw/NWIS_SiteFlowData_NE_RAW.csv') # if you use here it makes it more rigid/reliable - refers to specific folder / file path

dim(sites)

#Convert date column to date object (using lubridate)
